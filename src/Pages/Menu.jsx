...
const menuItems = [
  ...
  { 
    id: 7, 
    name: "12 Pc. Family Feast Bucket", 
    price: 1800, 
    category: "Buckets", 
  ...
  { 
    id: 8, 
    name: "4 Pc. Original Recipe Chicken", 
    price: 650, 
    category: "Buckets", 
    ...
    <div className="bg-[#FBF6F6] min-h-screen p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 border-l-8 border-[#D10000] pl-4">
          ...
          <p className="text-gray-600 mt-2">Explore our legendary range of finger lickin' good chicken.</p>
        </div>
